...
「条件面が不安」「資金繰りで失敗したくない」という方は、ぜひ一度ご相談ください。""",
    ...
    "faq": "Q:支払いサイトを30日から短く交渉できますか？|A:原則は難しいですが、エージェントによっては相談可能な場合や早期入金サービスを利用できることがあります。;Q:月末締め翌月20日払いは何日サイトですか？|A:20日サイトに相当する好条件です。業界標準より早く現金化できます。;Q:入金が遅れた場合はどうすればいいですか？|A:すぐに契約先へ連絡し支払日を確定させてください。条件次第では遅延利息請求が可能です。;Q:個人事業主の源泉徴収はどうなりますか？|A:原則として請求額から10.21%が源泉徴収されて入金されます。;Q:60日サイトでも単価が高ければ受けるべきですか？|A:十分な貯蓄がある場合は選択肢になりますが、資金体力とのバランスが重要です。",
